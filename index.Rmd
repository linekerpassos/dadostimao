...
ggplot()+
  ...
  annotate("text",x = 2010, y = 1.5,xend = 2011, yend = 1,label="Sanchez")+
  geom_vline(xintercept = 2012) +
  annotate("text",x = 2013, y = 1.5,xend = 2014, yend = 1,label="Gobbi") +
  geom_vline(xintercept = 2015) +
  annotate("text",x = 2016, y = 1.5,xend = 2017, yend = 1,label="Andrade") +
  geom_vline(xintercept = 2018) +
  annotate("text",x = 2019, y = 1.5,xend = 2019, yend = 1,label="Sanchez") +
  geom_vline(xintercept = 2021) +
  annotate("text",x = 2022, y = 1.5,xend = 2021, yend = 1,label="Duilio") +
  scale_fill_manual(name="",values=c("lightblue","#F8766D"))+
  scale_y_continuous(n.breaks = 10,labels = label_number(big.mark = "."))+
  labs(x = "Anos", y = "Valores em milhares",size=4) -> plot_ap
...
ggplot()+
  ...
  labs(x = "Anos", y = "Valores em milhares") -> plot_rd
...
ggplot()+
  ...
  labs(x = "Anos", y = "Qt. títulos") -> plot_tit
...
ggplot()+
  ...
  # scale_fill_manual(name="",values=c("#4699dd"))+
  scale_y_continuous(n.breaks = 20)+
  labs(x = "Anos", y = "Posição no Brasileirão") -> plot_pos
...
ggplot()+
  ...
  theme(legend.position = "bottom",
        legend.text = element_text(colour="black", size=10,
                                   face="bold"))+
  annotate("text",x = 2010, y = 1.5,xend = 2012, yend = 1,label="Sanchez")+
  geom_vline(xintercept = 2012) +
  annotate("text",x = 2013, y = 1.5,xend = 2014, yend = 1,label="Gobbi") +
  geom_vline(xintercept = 2015) +
  annotate("text",x = 2016, y = 1.5,xend = 2017, yend = 1,label="Andrade") +
  ...
  # scale_fill_manual(name="",values=c("#4699dd"))+
  scale_y_continuous(n.breaks = 20)+
  labs(x = "Anos", y = "Aproveitamento em %") 
ggplotly(plot_aprov)
